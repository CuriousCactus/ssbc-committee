...
function committee_shortcode($atts) {
    ...
    foreach ($cpresult as $cprow) {
       //computing_2 was added so a second computing officer could view things as a committee member. This line removes them from the committee page.
        if ($cprow->Position !== 'computing_2') {
